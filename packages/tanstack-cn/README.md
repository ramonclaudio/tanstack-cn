...
Thin redirect to [`create-tanstack-cn`](https://www.npmjs.com/package/create-tanstack-cn). `npx tanstack-cn` (or `bunx`, `pnpm dlx`, `yarn dlx`) prints these instructions and exits.
